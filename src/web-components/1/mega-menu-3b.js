...
document.body.insertAdjacentHTML(
  ...
  mega-menu-3b[data-is-mobile] img {
    display: none;
  }
  mega-menu-3b [data-mega-menu-3b="menu-item"] {
    display: block;
    background: orange;
    border: solid;
  }
  mega-menu-3b[data-is-desktop]:has([data-mega-menu-3b="menu-item"][open]) {
    background: blue;
    color: white;
  }
  mega-menu-3b[data-is-desktop] [data-mega-menu-3b="submenu"] {
    padding: 2rem;
    display: flex;
    gap: 2rem;
  ...
  mega-menu-3b[data-is-desktop] [data-mega-menu-3b="submenu"]  > img {
    aspect-ratio: 16 / 8;
    object-fit: cover;
  }
  mega-menu-3b[data-is-desktop] [data-mega-menu-3b="menu-item"] > span {
    display: block;
    padding: 0.5em 1em;
  }
  mega-menu-3b[data-is-desktop] [data-mega-menu-3b="menu-item"][data-level="2"] {
    background: green;
  }
  /*
      */
...
class MegaMenu3b extends HTMLElement {
  css = /*css*/`
      ...
      mega-menu-3b[data-is-mobile] [data-mega-menu-3b="menu"] {
        ...
        display: none;
        animation: mega-menu-3b--mobile--menu-exit 0.2s;
      }
      @keyframes mega-menu-3b--mobile--menu-exit {
        from {
          display: block;
      ...
      mega-menu-3b[data-is-mobile][data-is-opened-mobile] [data-mega-menu-3b="menu"] {
        display: block;
        animation: mega-menu-3b--mobile--menu-enter 0.2s;
      }
      @keyframes mega-menu-3b--mobile--menu-enter {
        from {
          display: block;
          transform-origin: top left;
          transform: scaleY(0);
      ...
      mega-menu-3b[data-is-mobile][data-is-opened-mobile] [data-mega-menu-3b="menu-item"][data-level="1"] {
        display: block;
        animation: mega-menu-3b--mobile--items-enter 0.4s both;
        animation-delay: calc(0.2s * var(--item-index--mobile) + 0.2s);
      }
      @keyframes mega-menu-3b--mobile--items-enter {
        from {
          display: block;
          opacity: 0;
        }
      ...
      mega-menu-3b[data-is-desktop] {
        display: block;
      }
      mega-menu-3b[data-is-desktop] [data-mega-menu-3b="menu"] {
        position: relative;
        height: 100%;
        display: flex;
      ...
      mega-menu-3b[data-is-desktop] [data-mega-menu-3b="menu-item"][data-level="1"] {
        height: 100%;
        display: flex;
        justify-content: center;
        align-items: center;
      ...
      mega-menu-3b[data-is-desktop] [data-mega-menu-3b="submenu"] {
        ...
        right: 0;
        pointer-events: none;
        animation: mega-menu-3b--desktop--submenu-exit 1  both;
      ...
      mega-menu-3b[data-is-desktop] [open] > [data-mega-menu-3b="submenu"] {
        pointer-events: all;
      ...
      @keyframes mega-menu-3b--desktop--submenu-enter {
        from {
          opacity: 0;
          transform: scaleY(0);
      ...
      @keyframes mega-menu-3b--desktop--submenu-exit {
        from {
          opacity: 1;
          transform: scaleY(1);
          transform-origin: top;
      ...
      @keyframes mega-menu-3b--desktop--submenu-children-enter {
        from {
          opacity: 0;
      ...
      @keyframes mega-menu-3b--desktop--submenu-children-exit {
        from {
          opacity: 1;
          transform: none;
        }
